...
import com.test.com.study.download.DownLoadListener;
import com.test.com.study.download.DownLoadManager;
import com.test.com.study.download.DownLoadService;
import com.test.com.study.download.TaskInfo;
                ...
                if(taskInfo.getTaskID().equals(sqlDownLoadInfo.getTaskID())){
                    for (int i = 0; i < curriculumClassificationListBeanList.size(); i++) {
                        if(curriculumClassificationListBeanList.get(i).getId().equals(sqlDownLoadInfo.getTaskID()))
                        {
                            ...
                            downloadBean.setTime(com.test.com.study.utils.DateUtils.formatDate(System.currentTimeMillis(),"yyyy-MM-dd HH:mm:ss"));
                            String url = "";
                            if ("1".equals(getIntent().getStringExtra("type")))
                            {
