...
public class HttpsRequest {
    ...
    protected OkHttpClient getOkHttpClinet() {
        ...
        okHttpClient.cookieJar(new CookieManger(MyApplication.getContext()));
//        //设置https
...
//        okHttpClient.sslSocketFactory(sslSocketFactory);
        ...
        Log.e("===","===="+MyApplication.getDataBase().getToken());
        okHttpClient.addInterceptor(new Interceptor() {
            @Override
            public Response intercept(Chain chain) throws IOException {
                Request request = chain.request()
                        .newBuilder()
                        .addHeader("token", MyApplication.getDataBase().getToken())
                        .build();
