...
import com.test720.wendujiaoyu.entity.TabEntity;
import com.test720.wendujiaoyu.firstFragmentactivity.NewsActivity1;
import com.test720.wendujiaoyu.fragements.BaoMingFragment;
import com.test720.wendujiaoyu.fragements.FirstFragment1;
import com.test720.wendujiaoyu.fragements.FourthFragment;
import com.test720.wendujiaoyu.fragements.SecondFragment1;
import com.test720.wendujiaoyu.fragements.ZiXunFragment;
import com.test720.wendujiaoyu.services.MyService;
...
public class MainActivity extends BaseToolbarActivity implements SharedInterFace, NewsCallBack {
    ...
    private void weChatLoginResult(String unionid, String nickName, String header) {
