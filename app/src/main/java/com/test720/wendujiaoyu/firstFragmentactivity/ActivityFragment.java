...
import com.test720.wendujiaoyu.entity.News;
...
public class ActivityFragment extends BaseFragment {
    ...
    public class QuickAdapter extends BaseQuickAdapter<News, BaseViewHolder> {
        ...
        protected void convert(BaseViewHolder viewHolder, News item) {
            ...
            Glide.with(getActivity()).load(UrlFactory.imagePath+item.getCover_img()).into((ImageView) viewHolder.getView(R.id.imageView));
        }
    }
