...
//    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.banli:
                if (type == 1) {
                    Glide.with(this).load(R.drawable.yewujieshao).asBitmap().into(content_relative);
                }

                else if (type == 2)
                    Glide.with(this).load(R.drawable.kaoshibaokao1).asBitmap().into(content_relative);
                else if (type == 3)
                    Glide.with(this).load(R.drawable.biyeshenqing1).asBitmap().into(content_relative);
                else if (type == 4)
                    Glide.with(this).load(R.drawable.xueweishenqing1).asBitmap().into(content_relative);
                else if (type == 5)
                    Glide.with(this).load(R.drawable.xueweiyingyu1).asBitmap().into(content_relative);
                else if (type == 6)
                    Glide.with(this).load(R.drawable.zhunkeozhengbuban1).asBitmap().into(content_relative);
                break;
            case R.id.xuzhi:
                if (type == 1)
                    Glide.with(this).load(R.drawable.yewuxuzhi).asBitmap().into(content_relative);
                else if (type == 2)
                    Glide.with(this).load(R.drawable.biyeshenqing2).asBitmap().into(content_relative);
                else if (type == 3)
                    Glide.with(this).load(R.drawable.kaoshibaokao2).asBitmap().into(content_relative);
                else if (type == 4)
                    Glide.with(this).load(R.drawable.xueweishenqing2).asBitmap().into(content_relative);
                else if (type == 5)
                    Glide.with(this).load(R.drawable.xueweiyingyu2).asBitmap().into(content_relative);
                else if (type == 6)
                    Glide.with(this).load(R.drawable.zhunkeozhengbuban2).asBitmap().into(content_relative);
                break;
            case R.id.callPhone:
