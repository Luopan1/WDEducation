package com.test720.wendujiaoyu.fourthFragementActivity.myorderfragment;
...
import com.test720.wendujiaoyu.entity.Order;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by LuoPan on 2017/8/19 16:19.
 */
...
public class AllOrderFragment extends BaseFragment {
    ...
    public AllOrderFragment newInstance() {
    ...
    public class QuickAdapter extends BaseQuickAdapter<Order.DataBean, BaseViewHolder> {
        ...
        protected void convert(BaseViewHolder viewHolder, final Order.DataBean item) {
            ...
            if (item.getType().equals("0")) {
                statue.setText("支付");
                statue.setTextColor(getResources().getColor(R.color.base_color));
                statue.setBackground(getResources().getDrawable(R.drawable.base_color_white));
