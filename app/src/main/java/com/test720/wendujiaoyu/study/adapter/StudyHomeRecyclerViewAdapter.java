...
import com.test720.wendujiaoyu.study.activity.ErrorAnswerActivity;
...
import com.test720.wendujiaoyu.study.activity.OldExamActivity;
import com.test720.wendujiaoyu.study.activity.VideoPlayActivity;
...
import com.test720.wendujiaoyu.study.view.DividerGridItemDecoration;
...
//                    sizeUtils.setLayoutSize(holder.getView(R.id.layout_bg), sizeUtils.screenWidth() / 4, sizeUtils.screenWidth() / 4);
            ...
            adapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
                ...
                public void onItemClick(RecyclerView parent, View view, int position) {
                    if(studyHomeTypeList.get(position).getName().equals("升级中"))
                    {
